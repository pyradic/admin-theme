...
declare module 'vue-styled-components' {
    ...
    export type StyledComponent = Vue.VueConstructor<_Vue & JSX.ElementClass>  & {
    ...
    export type StyledComponentElements = {
        [k in keyof JSX.IntrinsicElements]:  (str: TemplateStringsArray) =>  StyledComponent
    }
...
//     declare module 'vue-styled-components2' {
//     import * as CSS from "csstype";
//     import * as React from "react";
...
//                                        : P;
//
//     export type StyledComponentProps<// The Component from whose props are derived
//         C extends keyof JSX.IntrinsicElements | Vue.Component<any>,
...
//         O extends object
//         ? WithOptionalTheme<Omit<ReactDefaultizedProps<C, React.ComponentPropsWithRef<C>> & O, A> &
...
//     type WithChildrenIfReactComponentClass<C extends keyof JSX.IntrinsicElements | Vue.Component<any>> = C extends React.ComponentClass<any> ? { children?: React.ReactNode } : {};
//
//     type StyledComponentPropsWithAs<C extends keyof JSX.IntrinsicElements | Vue.Component<any>,
//         T extends object,
//         O extends object,
//         A extends keyof any> = StyledComponentProps<C, T, O, A> & { as?: C };
//
...
//         | Pick<StyledComponentBase<any, any, any, any>,
//         keyof StyledComponentBase<any, any>>
//         | Pick<StyledComponentBase<any, any, any>,
//         keyof StyledComponentBase<any, any>>;
//
// // abuse Pick to strip the call signature from ForwardRefExoticComponent
//     type ForwardRefExoticBase<P> = Pick<React.ForwardRefExoticComponent<P>,
...
//
//     export type StyledComponent<C extends keyof JSX.IntrinsicElements | Vue.Component<any>,
//         T extends object,
//         O extends object = {},
//         A extends keyof any = never> = // the "string" allows this to be used as an object key
//                                        // I really want to avoid this if possible but it's the only way to use nesting with object styles...
//         string & StyledComponentBase<C, T, O, A>;
//
//     export interface StyledComponentBase<C extends keyof JSX.IntrinsicElements | Vue.Component<any>,
//         T extends object,
//         O extends object = {},
//         A extends keyof any = never> extends ForwardRefExoticBase<StyledComponentProps<C, T, O, A>> {
...
//         // <AsC extends keyof JSX.IntrinsicElements | Vue.Component<any> = C>(
...
//                  */
//                 as?: keyof JSX.IntrinsicElements | Vue.Component<any>;
//             }
//         ): React.ReactElement<StyledComponentProps<C, T, O, A>>;
//
//         withComponent<WithC extends AnyStyledComponent>(
//             component: WithC
//         ): StyledComponent<StyledComponentInnerComponent<WithC>,
//             T,
//             O & StyledComponentInnerOtherProps<WithC>,
//             A | StyledComponentInnerAttrs<WithC>>;
//
//         withComponent<WithC extends keyof JSX.IntrinsicElements | Vue.Component<any>>(
//             component: WithC
//         ): StyledComponent<WithC, T, O, A>;
//     }
//
//     export interface ThemedStyledFunctionBase<C extends keyof JSX.IntrinsicElements | Vue.Component<any>,
//         T extends object,
//         O extends object = {},
...
//     }
//
//     export interface ThemedStyledFunction<C extends keyof JSX.IntrinsicElements | Vue.Component<any>,
//         T extends object,
//         O extends object = {},
//         A extends keyof any = never> extends ThemedStyledFunctionBase<C, T, O, A> {
...
//     }
//
//     export type StyledFunction<C extends keyof JSX.IntrinsicElements | Vue.Component<any>> = ThemedStyledFunction<C, any>;
//
//     type ThemedStyledComponentFactories<T extends object> = {
//         [TTag in keyof JSX.IntrinsicElements]: ThemedStyledFunction<TTag, T>
//     };
//
//     export type StyledComponentInnerComponent<C extends Vue.Component<any>> = C extends | StyledComponent<infer I, any, any, any>
//         | StyledComponent<infer I, any, any>
//                                                                                     ? I
//                                                                                     : C;
//     export type StyledComponentPropsWithRef<C extends keyof JSX.IntrinsicElements | Vue.Component<any>> = C extends AnyStyledComponent
//                                                                                                                 ? Vue.Component<StyledComponentInnerComponent<C>>
//                                                                                                                 : Vue.Component<C>;
//     export type StyledComponentInnerOtherProps<C extends AnyStyledComponent> = C extends | StyledComponent<any, any, infer O, any>
...
//         <C extends AnyStyledComponent>(component: C): ThemedStyledFunction<StyledComponentInnerComponent<C>,
//             T,
...
//
//     export type BaseWithThemeFnInterface<T extends object> = <C extends Vue.Component<any>>(
...
//         U extends object = T> = React.ComponentClass<ThemeProviderProps<T, U>>;
//     export type ThemeProviderComponent<T extends object,
//         U extends object = T> = BaseThemeProviderComponent<AnyIfEmpty<T>, AnyIfEmpty<U>>;
