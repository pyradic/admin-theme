...
namespace Pyro\AdminTheme\Ui\Command;


use Illuminate\Support\Str;
use Pyro\AdminTheme\Ui\Item;
use Illuminate\Support\Collection;
use Pyro\AdminTheme\Ui\ItemCollection;
...
class BuildFullControlPanelNavigation
{
    ...
    /** @var \Pyro\AdminTheme\Ui\ItemCollection */
    protected $resolved;
    ...
    protected function addResolvedSection(NavigationLinkInterface $link, Section $section)
    {
        ...
        /** @var \Pyro\AdminTheme\Ui\Item $linkItem */
